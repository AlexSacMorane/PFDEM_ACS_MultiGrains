...
def All_parameters():
    ...
    # Config, C_at_P, Diff_Solute, dt, Ed, Etai_distribution, Eta_c, Init_Current_Shape, Kc, Movie (need Config to work), Mesh, Sphericity, sum_Ed
    L_flag_plot = ['Config', 'Sphericity', 'Movie', 'sum_Ed', 'Ed', 'Mesh', 'Etai_distribution']
