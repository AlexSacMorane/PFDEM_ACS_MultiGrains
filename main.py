...
def iteration_main(dict_algorithm, dict_material, dict_sample, dict_sollicitation, dict_tracker, simulation_report):
    ...
    while DEM_loop_statut :
        ...
        if dict_algorithm['i_DEM'] % dict_algorithm['i_print_plot'] == 0:
            print('\nPF '+str(dict_algorithm['i_PFDEM'])+' -> i_DEM '+str(dict_algorithm['i_PFDEM']+1)+' / '+str(dict_algorithm['i_DEM_stop']+1)+' (max)')
        ...
        if dict_algorithm['i_DEM'] > 0.1*dict_algorithm['i_DEM_stop'] and Ecin < dict_algorithm['Ecin_stop'] and (dict_sollicitation['Vertical_Confinement_Force']*0.95<dict_sollicitation['Force_on_upper_wall'] and dict_sollicitation['Force_on_upper_wall']<dict_sollicitation['Vertical_Confinement_Force']*1.05):
